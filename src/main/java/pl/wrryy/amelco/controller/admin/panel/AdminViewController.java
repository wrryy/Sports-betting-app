...
public class AdminViewController {
    ...
    public String listUsers(Model model, @SortDefault("id") Pageable pageable) {
        model.addAttribute("user", new User());
        return "admin/users";
    }

    @RequestMapping("/roles")
    public String listRoles(Model model, @SortDefault("id") Pageable pageable) {
    ...
    public String listGames(Model model, @SortDefault("started") Pageable pageable) {
    ...
    public String listTeams(Model model, @SortDefault("id") Pageable pageable) {
    ...
    public String listCategories(Model model, @SortDefault("id") Pageable pageable) {
        model.addAttribute("sport", new Sport());
        return "admin/categories";
    }
    @RequestMapping("/content")
    public String listSubContent(Model model, @SortDefault("id") Pageable pageable) {
    ...
    public String listTopics(Model model, @SortDefault("id") Pageable pageable) {
